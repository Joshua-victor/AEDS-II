...
public class Main 
{
    ...
    public static boolean compare(int j, Pokemon tmp)
    {
        tp.addComp(1);
        return (array[j].getCaptureDate().after(tmp.getCaptureDate()));
    }
    ...
    public static void main(String args[])
    {
        ...
        tp.ordenacaoFile("789339_insercao.txt");
